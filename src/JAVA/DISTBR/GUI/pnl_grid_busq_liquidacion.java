...
public class pnl_grid_busq_liquidacion extends javax.swing.JPanel {

    public pnl_grid_busq_liquidacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(TBL_liquidacion);
        if (TBL_liquidacion.getColumnModel().getColumnCount() > 0) {
            ...
            TBL_liquidacion.getColumnModel().getColumn(1).setPreferredWidth(25);
            TBL_liquidacion.getColumnModel().getColumn(2).setResizable(false);
            TBL_liquidacion.getColumnModel().getColumn(2).setPreferredWidth(100);
            TBL_liquidacion.getColumnModel().getColumn(3).setResizable(false);
            TBL_liquidacion.getColumnModel().getColumn(3).setPreferredWidth(50);
        }
