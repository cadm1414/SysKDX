...
public class dlg_busq_facturacion_pr extends javax.swing.JDialog {
        ...
        try {
            ...
            if (lq_rs != null) {
                do {
                    ...
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getString(1), a, 0);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getString(4), a, 1);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getString(5), a, 2);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getDouble(6), a, 3);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getString(7), a, 4);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(go_fnc_operaciones_campos.int_boolean(lq_rs.getInt(8)), a, 5);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getDouble(9), a, 6);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getInt(3), a, 7);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getDouble(11), a, 8);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getDouble(12), a, 9);
                    lo_pnl_grid_facturacion_pr.TBL_facturacion.setValueAt(lq_rs.getString(17), a, 10);
        ...
        public void keyPressed(KeyEvent ke) {
            if (ke.getKeyCode() == KeyEvent.VK_ENTER) {
                if (ke.getSource() == TXT_dato) {
                    if (lo_pnl_grid_facturacion_pr.TBL_facturacion.getRowCount() != 0) {
                        lo_pnl_grid_facturacion_pr.TBL_facturacion.requestFocus();
                        lo_pnl_grid_facturacion_pr.TBL_facturacion.changeSelection(0, 0, false, false);
                    } else {
                        TXT_dato.requestFocus();
                    }
                }
                if (ke.getSource() == lo_pnl_grid_facturacion_pr.TBL_facturacion) {
                    retorna();
                }
            }
    ...
    MouseListener MouseEvnt = new MouseListener() {
        ...
        public void mouseClicked(MouseEvent me) {
            if (me.getSource() == lo_pnl_grid_facturacion_pr.TBL_facturacion && me.getClickCount() == 2) {
                retorna();
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlg_busq_facturacion_pr dialog = new dlg_busq_facturacion_pr(new javax.swing.JFrame(), true);
