...
public class dlg_datos_pl extends javax.swing.JDialog {
    ...
    ResultSet lq_rs;
    String ls_codigo_entidad, ls_codigo_direccion;
    ...
    public void get_transportista_ini() {
        try {
    ...
    private void evt_f5_direccion() {
        ...
        if (ls_codigo_direccion != null) {
            ...
            go_fnc_mensaje.GET_mensaje(2, ls_modulo, ls_capa, ls_clase, "evt_buscar", "SELECCIONE DIRECCION");
