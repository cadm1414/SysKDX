...
public class pnl_datos_seleccion_guiar_v2 extends javax.swing.JPanel {


    public pnl_datos_seleccion_guiar_v2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (TBL_detalle_guiar.getColumnModel().getColumnCount() > 0) {
            ...
            TBL_detalle_guiar.getColumnModel().getColumn(2).setPreferredWidth(230);
            TBL_detalle_guiar.getColumnModel().getColumn(3).setResizable(false);
            TBL_detalle_guiar.getColumnModel().getColumn(3).setPreferredWidth(30);
            ...
            TBL_detalle_guiar.getColumnModel().getColumn(5).setPreferredWidth(30);
            TBL_detalle_guiar.getColumnModel().getColumn(6).setResizable(false);
            TBL_detalle_guiar.getColumnModel().getColumn(6).setPreferredWidth(1);
        }
