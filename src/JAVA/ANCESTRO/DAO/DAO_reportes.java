...
public class DAO_reportes {
    ...
    public double RPT_utilidad_ponderada(String codigo_sucursal, String codigo_producto, double precio) {
        double resp = 0;
        try {
            lq_stm = go_conexion_db.crearStatement();
            String SQL = "select * from rpt_utilidad_ponderada('" + codigo_sucursal + "','" + codigo_producto + "'," + precio + ",'" + gs_periodo + "') "
