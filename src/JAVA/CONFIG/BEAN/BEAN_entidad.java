...
public class BEAN_entidad {
    ...
    public String getEs_trabajador() {
        return es_trabajador;
    }

    public void setEs_trabajador(String es_trabajador) {
    ...
    public String getAgente_percepcion() {
        return agente_percepcion;
    }

    public void setAgente_percepcion(String agente_percepcion) {
        this.agente_percepcion = agente_percepcion;
    }

    public String getAgente_retencion() {
        return agente_retencion;
    }

    public void setAgente_retencion(String agente_retencion) {
        this.agente_retencion = agente_retencion;
    }

    public String getEntidad_excluida() {
        return entidad_excluida;
    }

    public void setEntidad_excluida(String entidad_excluida) {
        this.entidad_excluida = entidad_excluida;
    }
