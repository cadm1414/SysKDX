...
public class BEAN_general {
    ...
    String ruc, razon_social, giro, direccion, codigo_ubigeo, descripcion_ubigeo;
    String telefono, fax, e_mail, website, nombre_reporte, fecha_actividad;
    String codigo_moneda, imagen_logo, imagen_portada;
