...
public class dlg_busq_entidad_parametros extends javax.swing.JDialog {
    ...
    public dlg_busq_entidad_parametros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        formulario();
        datos_tabla();
    ...
    private void datos_tabla() {
        ...
        try {
            lq_rs = go_dao_entidad.SLT_grid_entidad_parametros(gs_parametros[0], gs_parametros[1], gs_parametros[2], gs_parametros[3], gs_parametros[4]);
            limpia_parametros();
            if (lq_rs != null) {
                do {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlg_busq_entidad_parametros dialog = new dlg_busq_entidad_parametros(new javax.swing.JFrame(), true);
