...
public class evt_datos_articulo_costo {
    ...
    public void muestra_datos(pnl_datos_articulo_costo OBJ_pda, BEAN_articulo_costo OBJ_bar) {
        ...
        OBJ_pda.TXT_nombre_entidad.setText("....");
        OBJ_pda.TXT_fecha_ingreso.setText(go_fnc_operaciones_campos.recupera_fecha(OBJ_bar.getFecha_ingreso()));
        OBJ_pda.TXT_fecha_produccion.setText(go_fnc_operaciones_campos.recupera_fecha(OBJ_bar.getFecha_produccion()));
        OBJ_pda.TXT_fecha_vencimiento.setText(go_fnc_operaciones_campos.recupera_fecha(OBJ_bar.getFecha_vencimiento()));
    }
    ...
    public void setea_recupera(BEAN_articulo_costo OBJ_bar, ResultSet lq_rs) {
        try {
            ...
            OBJ_bar.setFecha_ingreso(lq_rs.getString(12));
            OBJ_bar.setFecha_produccion(lq_rs.getString(13));
            OBJ_bar.setFecha_vencimiento(lq_rs.getString(14));
        } catch (Exception e) {
        }
    }
