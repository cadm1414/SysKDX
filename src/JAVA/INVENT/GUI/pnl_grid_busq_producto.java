...
public class pnl_grid_busq_producto extends javax.swing.JPanel {

    ActionMap am;

    public pnl_grid_busq_producto() {
        initComponents();
        am = TBL_producto.getActionMap();
    ...
    private void initComponents() {
        ...
        if (TBL_producto.getColumnModel().getColumnCount() > 0) {
            ...
            TBL_producto.getColumnModel().getColumn(0).setPreferredWidth(20);
            TBL_producto.getColumnModel().getColumn(1).setResizable(false);
            TBL_producto.getColumnModel().getColumn(1).setPreferredWidth(110);
