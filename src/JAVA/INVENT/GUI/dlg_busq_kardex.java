...
public class dlg_busq_kardex extends javax.swing.JDialog {
    ...
    private void get_parametros() {
        ...
        ls_codigo_movimiento = gs_parametros[3];
        ls_tipo_movimiento = gs_parametros[4];
        ls_es_transferencia = gs_parametros[5];
    ...
    private void formulario() {
        lo_pnl_grid_kardex.setBounds(0, 0, 300, 220);
        PNL_grid.add(lo_pnl_grid_kardex);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlg_busq_kardex dialog = new dlg_busq_kardex(new javax.swing.JFrame(), true);
