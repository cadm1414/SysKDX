...
public class pnl_grid_busq_marca extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(TBL_marca);
        if (TBL_marca.getColumnModel().getColumnCount() > 0) {
            TBL_marca.getColumnModel().getColumn(0).setResizable(false);
            TBL_marca.getColumnModel().getColumn(0).setPreferredWidth(20);
            TBL_marca.getColumnModel().getColumn(1).setResizable(false);
            TBL_marca.getColumnModel().getColumn(1).setPreferredWidth(110);
            TBL_marca.getColumnModel().getColumn(2).setResizable(false);
            TBL_marca.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
