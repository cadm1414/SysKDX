...
public class BEAN_articulo {
    ...
    public String getCodigo_subfamilia() {
        return codigo_subfamilia;
    }

    public void setCodigo_subfamilia(String codigo_subfamilia) {
    ...
    public String getCodigo_percepcion() {
        return codigo_percepcion;
    }

    public void setCodigo_percepcion(String codigo_percepcion) {
        this.codigo_percepcion = codigo_percepcion;
    }
    ...
    public void setCodigo_detraccion(String codigo_detraccion) {
        this.codigo_detraccion = codigo_detraccion;
    }
    ...
    public String getBulto_um() {
        return bulto_um;
    }

    public void setBulto_um(String bulto_um) {
        this.bulto_um = bulto_um;
    }
